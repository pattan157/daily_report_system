...
public class ReportService extends ServiceBase {
    ...
    /*
     * (追記分)指定したレポートを1件取得し、ReportViewのリストで返却する
     * @param ev 従業員名
     * @return paramに入れた従業員の最新のレポート
     */
    public List<ReportView> getLastReport(EmployeeView ev) {
        List<Report> reports = em.createNamedQuery(JpaConst.Q_REP_GET_LAST_REPORT, Report.class)
