...
public interface JpaConst {
    ...
    String REP_COL_HEIGHT = "height"; //身長
    String REP_COL_WEIGHT = "weight"; //体重
    String REP_COL_BMI = "bmi"; //BMI
    String REP_COL_CREATED_AT = "created_at"; //登録日時
    String REP_COL_UPDATED_AT = "updated_at"; //更新日時
    
    //Entity名
    String ENTITY_EMP = "employee"; //従業員名
    String ENTITY_REP = "report"; //日報
    
    //JPQL内パラメータ
    String JPQL_PARM_CODE = "code"; //社員番号
    String JPQL_PARM_PASSWORD = "passwprd"; //パスワード
    ...
    String Q_EMP_COUNT_RESISTERED_BY_CODE = ENTITY_EMP + ".countRegisterdByCode";
